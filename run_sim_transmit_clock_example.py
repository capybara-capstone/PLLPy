...
h = np.load("data_for_serdespy_examples/h_thru.npy")
h_ctle = np.load("./data_for_serdespy_examples/h_ctle.npy")
ffe_tap_weights = np.load("./data_for_serdespy_examples/rx_ffe_tap_weights.npy")
dfe_tap_weights = np.load("./data_for_serdespy_examples/rx_dfe_tap_weights.npy")
tx_fir_tap_weights = np.load("./data_for_serdespy_examples/tx_fir_tap_weights.npy")
